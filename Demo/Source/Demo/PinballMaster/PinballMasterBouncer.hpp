...
#include "PinballMasterBouncer.generated.hpp"
...
namespace Demo
{
	class DClass(Serialize) PinballMasterBouncer : public D_ECS_COMP::BehaviourComponent
	{
		GENERATED_BODY();

		D_H_BEHAVIOUR_COMP_BODY(PinballMasterBouncer, D_ECS_COMP::BehaviourComponent, "Pinball Master/Pinball Master Bouncer", true, true);
...
File_PinballMasterBouncer_GENERATED
