...
namespace Darius::Editor::Gui::Windows
{
	...
	private:
        ...
        static void                 ConfigureSequencerForComponent(Components::AnimationSequence& seq, ComponentBase* comp, D_ANIMATION::AnimationResource* animationResource, int& currentFrameRef);
