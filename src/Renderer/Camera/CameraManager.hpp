...
namespace Darius::Renderer::CameraManager
{
	...
	void SetActiveCamera(D_ECS::CompRef<D_RENDERER::CameraComponent> cam, int index = 0);
	D_ECS::CompRef<D_RENDERER::CameraComponent> GetActiveCamera(int index = 0);

	void RegisterCamera(D_ECS::CompRef<D_RENDERER::CameraComponent> cam);
