...
namespace Darius::Renderer::Geometry::ModelLoader::Fbx
{
	...
	bool													ReadMeshByName(D_FILE::Path const& path, std::wstring const& meshName, MultiPartMeshData<D_RENDERER_VERTEX::VertexPositionNormalTangentTextureSkinned>& result, D_CONTAINERS::DList<D_RENDERER_GEOMETRY::Mesh::SkeletonJoint>& skeleton);
