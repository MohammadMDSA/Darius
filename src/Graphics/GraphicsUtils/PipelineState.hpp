...
namespace Darius::Graphics::Utils
{
	...
	protected:
		...
		struct PsoShaderData
		{
			...
			INLINE ~PsoShaderData()
			{
				if (OnShaderCompiledConnection.connected())
					OnShaderCompiledConnection.disconnect();
			}
	...
	private:
		...
		INLINE void OnVertexShaderRecompiled() { Finalize(); }
		INLINE void OnPixelShaderRecompiled() { Finalize(); }
		INLINE void OnGeometryShaderRecompiled() { Finalize(); }
		INLINE void OnHullShaderRecompiled() { Finalize(); }
		INLINE void OnDomainShaderRecompiled() { Finalize(); }
