...
namespace Darius::Graphics::Utils
{
	...
	uint64_t CommandQueue::ExecuteCommandList(ID3D12CommandList* List, D3DX12Residency::ResidencySet* ResidencySet)
	{
		...
		D3DX12Residency::ResidencySet* sets[] = {ResidencySet};
		D_GRAPHICS_DEVICE::GetResidencyManager().ExecuteCommandLists(mCommandQueue, &List, sets, 1);
