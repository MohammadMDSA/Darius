...
namespace Darius::Graphics::Utils::Buffers
{
	...
	public:
		...
		INLINE UINT GetWidth() const { return (UINT)mMetaData.Width; }
		INLINE UINT GetHeight() const { return (UINT)mMetaData.Height; }
		INLINE UINT GetDepth() const { return (UINT)mMetaData.Depth; }

		INLINE bool     Is1D() const { return mMetaData.Dimension == TextureMeta::TEX_DIMENSION_TEXTURE1D; }
		INLINE bool     Is2D() const { return mMetaData.Dimension == TextureMeta::TEX_DIMENSION_TEXTURE2D; }
		INLINE bool     Is3D() const { return mMetaData.Dimension == TextureMeta::TEX_DIMENSION_TEXTURE3D; }
		INLINE UINT     ArraySize() const { return (UINT)mMetaData.ArraySize; }
