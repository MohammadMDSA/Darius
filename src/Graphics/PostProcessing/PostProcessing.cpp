...
#undef CreatePSO
	...
	bool OptionsDrawer(_IN_OUT_ D_SERIALIZATION::Json& options)
	{
		...
		else
		{
			...
			D_H_OPTION_DRAW_FLOAT_SLIDER("Target Luminance", "PostProcessing.HDR.TargetLuminance", TargetLuminance, 0.01f, 10.f);
		...
		D_H_OPTION_DRAW_CHECKBOX("Enable Color Grading", "PostProcessing.ToneMapper.ColorGrading.Enable", EnableColorGrading);
		{
			...
			D_H_OPTION_DRAW_FLOAT_SLIDER("Color Correction Shadows Max", "PostProcessing.ToneMapper.ColorGrading.ColorCorrectionShadowsMax", colorGradingParams.ColorCorrectionShadowsMax, -1.f, 1.f);
